...
namespace Assets.IntruderMM.Editor
{
	...
	public class Preferences
	{
		...
		{
			var provider = new SettingsProvider( "Intruder Tools", SettingsScope.User )
			{
				guiHandler = ( e ) => { CustomPreferencesGUI(); },
			};
		...
		{
			// Copyright
			EditorGUILayout.LabelField( "Intruder Tools Created by Superboss Games", EditorStyles.centeredGreyMiniLabel );
